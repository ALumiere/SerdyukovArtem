...
_Меня зовут Артем. Я QA Enginner - cильный специалист в области средств массовой информации и коммуникаций со степенью бакалавра технологий в области компьютерных наук и инженерии. Я специализируюсь на тестировании API и мобильных приложений_
...
Kibana - анализ логов и ошибок;

DevTools - анализ запросов/ответов при помощи Console; Анализ загрузки сайта и скорости работоспособности при помощи Network; Тестирование html/css при помощи Elements
...
[![Telegram Badge](https://img.shields.io/badge/-Telegram-0088cc?style=flat-square&logo=Telegram&logoColor=white)](mailto:aslumiere@gmail.com)
